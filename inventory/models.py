...
class Categorie(models.Model):
    category_name = models.CharField(max_length=50, default='Generic', help_text='Enter the category of the item')

    def __str__(self):
        return str(self.category_name)

class Item(models.Model):
    category = models.ForeignKey('Categorie', on_delete=models.CASCADE, help_text='Select the category of the equipment')
    ...
    cost_per_item = models.DecimalField(decimal_places=2, max_digits=10, null=True, help_text='Enter the cost per item')
    ...
    # def quantity(self):
        # return self.working+self.in_maintenance
...
class Room(models.Model):
    ...
    room_name = models.CharField(max_length=20, default='Generic', help_text='Enter the name of the room')
